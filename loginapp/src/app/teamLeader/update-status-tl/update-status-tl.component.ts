...
import { TaskStatus } from 'src/app/service/TaskStatus';
import { Priority } from 'src/app/service/priority';
...
@Component({
  ...
  templateUrl: './update-status-tl.component.html',
  styleUrls: ['./update-status-tl.component.css']
})
export class UpdateStatusTLComponent {
   //task
 task :Task = new Task();
